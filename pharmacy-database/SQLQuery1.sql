...
(
    ...
    indications_for_use NVARCHAR(500),
    manufacturer_id INT FOREIGN KEY REFERENCES Manufacturer(id)
);
...
(
    ...
    medication_type_id INT FOREIGN KEY REFERENCES MedicationType(id)
);
...
(
    ...
    medication_type_id INT FOREIGN KEY REFERENCES MedicationType(id),
    PRIMARY KEY(disease_id, medication_type_id)
);

-- Партия лекарства-продажи
CREATE TABLE MedicineBatch_Sales
(
    medicine_batch_id INT FOREIGN KEY REFERENCES MedicineBatch(id),
    sales_id INT FOREIGN KEY REFERENCES Sales(id),
    quantity INT NOT NULL CHECK (quantity > 0),  
    PRIMARY KEY(medicine_batch_id, sales_id)
);
...
INSERT INTO MedicationType ([name], [status], active_substance, annotation, indications_for_use, manufacturer_id) VALUES
...
INSERT INTO Sales ([date], amount, cashier_id) VALUES
...
INSERT INTO MedicineBatch (price, quantity, expiration_date, medication_type_id) VALUES
...
INSERT INTO MedicationType_Disease (disease_id, medication_type_id) VALUES
(1, 1),
(1, 7), 
(2, 3),
(3, 9), 
...
INSERT INTO MedicineBatch_Sales (medicine_batch_id, sales_id, quantity) VALUES
(1, 1, 2),
(4, 1, 1), 
(2, 2, 1), 
(5, 2, 3), 
